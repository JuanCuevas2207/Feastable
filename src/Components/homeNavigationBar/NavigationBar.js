    ...
    <div className={[NavBarStyles.header, 'py-2 align-items-center'].join(" ")}>  
      ...
      <div className={'px-md-5 px-sm-3'}>
        <div className={'float-right'}>
          ...
          <img onClick={()=>props.history.push("/settings")} className={['mx-md-2 mx-1 rounded-circle', NavBarStyles.menuImg].join(" ")} src="assets/icons/profile-pic.jpg" alt="Profile icon" height="30px" width="30px"></img>
        </div>
      </div>   
    </div>
  )
